...
const CURATED: HideSpot[] = [
  ...
  spot(7.5, FLOOR, -3.6, 0.45), // 本棚の前（左・小さめで紛れる）
  ...
  spot(1.2, FLOOR, 7.4, 0.45), // サイドボードの前（右・小さめ）
  spot(-0.9, FLOOR, 7.5, 0.45), // サイドボードの前（左・小さめ）
  ...
  spot(8.4, 0.65, -3.8, 0.4, -Math.PI / 2), // 本棚の棚の中（下段・左）
  spot(8.4, 1.3, -2.05, 0.4, -Math.PI / 2), // 本棚の棚の中（中段・右）
  spot(8.4, 1.95, -3.7, 0.4, -Math.PI / 2), // 本棚の棚の中（中段・左）
  spot(8.4, 2.6, -2.2, 0.4, -Math.PI / 2), // 本棚の棚の中（上段・右）
  spot(8.4, 2.6, -3.5, 0.4, -Math.PI / 2), // 本棚の棚の中（上段・左）
  ...
  spot(-5.35, FLOOR, 7.7, 0.4), // 植物とラダーシェルフの隙間
  ...
  spot(8.4, 0.65, -2.2, 0.4, -Math.PI / 2), // 本棚の棚の中（下段・右）
  spot(8.4, 1.95, -2.3, 0.4, -Math.PI / 2), // 本棚の棚の中（中段・右2）
  ...
  spot(-1.2, FLOOR, -8.4, 0.4), // 窓下クッションの陰
  ...
  spot(8.4, 3.2, -2.5, 0.4, -Math.PI / 2), // 本棚の棚の中（最上段・右）
  spot(8.4, 3.2, -3.6, 0.4, -Math.PI / 2), // 本棚の棚の中（最上段・左）
